...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/15 12:08:14 by estarck           #+#    #+#             */
/*   Updated: 2023/02/27 09:03:24 by estarck          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	class random_access_iterator : public ft::iterator< ft::random_access_iterator_tag, T >
	{
		...
		public:
			...
			random_access_iterator(pointer _ptr = nullptr) : _ptr(_ptr)
			{}
			...
			//@brief Returns a pointer to the pointed  (in order to access one of its members).
			...
			//@brief Returns a iterator pointing to the _ptrent located n positions away from the _ptrent the iterator _ptrly points to.
			...
			//@brief Returns a iterator pointing to the _ptrent located n positions before the _ptrent the iterator _ptrly points to.
			random_access_iterator operator-(difference_type n) const
			{ return random_access_iterator(this->_ptr - n); }
			...
			//@brief Accesses the _ptrent located n positions away from the _ptrent _ptrly pointed to by the iterator.
	...
	//@brief Returns a iterator pointing to the _ptrent located n positions away from the _ptrent pointed to by iter.
	//@param n  Number of _ptrents to offset. Member type difference_type is an alias of Iterator's own difference type.
	//@param iter iterator.
...
#endif  /* _RANDOM_ACCESS_ITERATOR_HPP_ */